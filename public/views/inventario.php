            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../../app/controllers/ControladorInventario.php" method="POST" id="productForm">
...
<div class="modal fade" id="editProductModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../../app/controllers/ControladorInventario.php" method="POST" id="editProductForm">
...
function openEditModal(id_ropa) {
    fetch(`../../app/controllers/ControladorInventario.php?tipo=obtener&id_ropa=${id_ropa}`)
...
function deleteProduct(id_ropa) {
    if (confirm("¿Estás seguro de que deseas eliminar esta prenda?")) {
        fetch(`../../app/controllers/ControladorInventario.php?tipo=eliminar&id_ropa=${id_ropa}`)
